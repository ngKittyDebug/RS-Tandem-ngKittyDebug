...
PR with questions from peers and mentor: `TODO: add link to this PR after creating it`
...
|                      | **Сложный бэкенд-сервис:** Game Server Engine, Matchmaking System, AI Context Manager, Code Execution Sandbox          | +30                | [PR #136](https://github.com/ngKittyDebug/RS-Tandem-ngKittyDebug/pull/136) | Бэкенд-часть AI для merge-game: endpoint проверки ответов, DTO/enum, защита endpoint, обработка ответа AI и исправления по PR. |
...
| **DevOps & Role**    | **Prompt Engineering:** Документирование 3+ итераций улучшения промптов                                                | +15                | Дневники разработки | Экспериментировала с ChatGPT, Claude и Groq: генерация слов для игры, помощь в разборе NestJS, тестов, Drag & Drop, AI-интеграции и ревью кода с последующей ручной проверкой решений. |
|                      | **Architect:** Документирование архитектурных решений (схемы, ADR)                                                     | +10                | Дневники разработки | Зафиксировала и описала архитектурные решения по merge-game: роутинг внутри игры, разделение на `GameService`, `BoardService`, `QuizService`, перенос AI логики с frontend на backend. |
|                      | **Auto-deploy:** Настройка автоматического деплоя (Vercel/Netlify/GH Actions)                                          | +5                 | [PR #181](https://github.com/ngKittyDebug/RS-Tandem-ngKittyDebug/pull/181) | Работала с Netlify-конфигом и исправлениями деплоя, участвовала в разборе проблем со страницами в преддеплое. |
| **Architecture**     | **Design Patterns:** Явное и обоснованное применение паттернов в коде                                                  | +10                | [PR #106](https://github.com/ngKittyDebug/RS-Tandem-ngKittyDebug/pull/106) | Разделила игру по зонам ответственности: `GameService`, `BoardService`, `QuizService`; убрала лишние мутации и дублирование сигналов. |
...
**Итоговая сумма по фичам: 340 баллов**
...
![Покрытие тестов 1](./assets/test-coverage-1.png)
![Покрытие тестов 2](./assets/test-coverage-2.png)
![Покрытие тестов 3](./assets/test-coverage-3.png)
